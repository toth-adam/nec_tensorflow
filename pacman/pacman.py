...
setup_logging(file_handler_filename="/media/david/df8ae8cc-4282-4f1f-abce-0b066034555d/david/RL/pacman_2017_12_07/run_4/log.txt", is_file_handler=True)
# setup_logging()

nec_agent_parameters_dict = {
    "dnd_max_memory": 100000,
    "log_save_directory": "/media/david/df8ae8cc-4282-4f1f-abce-0b066034555d/david/RL/pacman_2017_12_07/run_4",
    "input_shape": (42, 42, 4),
...
# agent.full_load("/media/david/df8ae8cc-4282-4f1f-abce-0b066034555d/david/RL/nec_pacman_1204_1", 1152490)
...
for i in range(max_ep_num):
    ...
    if time.time() - last_save_time > 9000:
        agent.full_save("/media/david/df8ae8cc-4282-4f1f-abce-0b066034555d/david/RL/nec_pacman_mikluas")
        last_save_time = time.time()
        print("/////////////////////////////////////// SAVE ////////////////////////////////////////")
